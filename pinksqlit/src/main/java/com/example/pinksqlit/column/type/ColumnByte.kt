...
class ColumnByte<E>(
    ...
    override val mapValue: (entity: E) -> Byte?,
    ...
    override fun getValue(cursor: Cursor?): Byte? = cursor?.getInt(position)?.toByte()
    override fun valueToString(velue: Byte?): String = velue.toString()
}